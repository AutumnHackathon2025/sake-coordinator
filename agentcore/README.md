...
カテゴリー名は、AIが推薦理由や特徴に応じて動的に生成します。

- **文字数制限**: 1-10文字
- **内容**: 推薦理由や特徴を簡潔に表現
- **best_recommendには含まれない**: 最もマッチ度が高い銘柄にはカテゴリーは付与されません
...
**注意事項**:
- カテゴリー名は推薦ごとに異なる可能性があります
- AIが文脈に応じて最適なカテゴリー名を生成します
- カテゴリーが無効な場合（空文字列や10文字超過）は、デフォルト値「おすすめ」が設定されます
